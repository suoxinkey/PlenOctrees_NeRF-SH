...
sample_t = rsp.forward(rays[:5000].reshape(-1,6), bbox, method=None)
# print('sample_t', sample_t[200])
# pt = sample_t.reshape((-1,1,8)) * rays[:5000,:3].reshape((-1,3,1)) + rays[:5000,3:].reshape((-1,3,1))
# fig = plt.figure()
# axes3d = Axes3D(fig)
# axes3d.scatter(pt[200,0], pt[200,1], pt[200,2])
# plt.show()
